...
import {
    ...
    healthCheck,
    getAppointmentHistoryOfClinicSideTable
...
/**
 * @exports router to consult a patient using questionnaires provided in clinic side table and questionnaires
 */
router.post("/cms.api.com/clinic/dashboard/clinicConsultPatient", verifyToken, consultPatientInClinicSideAppointment);
...
/**
 * @exports router to searched approved booked appointments of a patient in patient side
 */
router.get("/cms.api.com/patient/dashboard/searchedApprovedBookedAppointments", verifyToken, searchApprovedBookedAppointments);
...
/**
 * @exports router to retrieve the consulted patients in clinic side table appointment history
 */
router.get(`/cms.api.com/clinic/clinic-table-appointment-history`, verifyToken, getAppointmentHistoryOfClinicSideTable);
